...
class Comments:
    ...
    def get(videoLink: str, mode: int = ResultMode.dict, timeout: int = None) -> Union[
        dict, str, None]:
        commentsInternal = CommentsCore(videoLink, timeout=timeout)
...
class Transcript:
    ...
    def get(videoLink: str, mode: int = ResultMode.dict, timeout: int = None) -> Union[
        dict, str, None]:
        transcriptInternal = TranscriptCore(videoLink, None, timeout=timeout)
...
class Channel:
    ...
    def get(channelId: str, mode: str = ChannelRequestType.playlists, timeout: int = None) -> Union[
        dict, str, None]:
        channelInternal = ChannelCore(channelId, mode, timeout=timeout)
