    ...
    def _parseSource(self) -> None:
        try:
            ...
            if not self.continuationKey:
                responseContent = self._getValue(parsed_response, contentPath)
            else:
                responseContent = self._getValue(parsed_response, continuationContentPath)
            if responseContent:
                ...
                self.responseSource = self._getValue(parsed_response, fallbackContentPath)
